      ...
      <div className="">
        ...
        <div className="items-start space-y-2 xl:grid xl:grid-cols-3 xl:gap-x-8 xl:space-y-0">
          ...
          <div className="pt-8 pb-8 prose dark:prose-dark max-w-none xl:col-span-2">
            ...
            {/* to-do in the future, update now page */}
            ...
            <br />
            {/* to-do in the future, update uses page after getting proper */}
            {/* <p>
              {text3} <br />
              <Link
                href={'/uses'}
            ...
            <br />
            <p>
              Feel free to reach out if you have anything to discuss about @ <br></br>
              <RoughNotation type="highlight" show={true} color="#FBCFE8" animationDelay={1200}>
                <span className="dark:text-gray-700">yenwei9761@gmail.com</span>
              </RoughNotation>
            </p>
          </div>
        </div>
