...
export default function CommandBar(props) {
  ...
  const actions = [
    ...
    },
    {
      ...
      keywords: 'send-email',
      section: 'General',
      perform: () => window.open('mailto:yenwei9761@gmail.com', '_blank'),
    ...
    },
    {
      ...
      section: 'General',
      perform: () => window.open('https://github.com/yenweitan', '_blank'),
    ...
    },
    {
      ...
      section: 'Follow',
      perform: () => window.open('https://www.linkedin.com/in/yen-wei-tan-588326160/', '_blank'),
